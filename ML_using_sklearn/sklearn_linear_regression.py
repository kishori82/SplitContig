...
def main(argv, errorlogger = None, runstatslogger = None):
	...
	print("Linear Regression accuracy on training set = %f" % (lr.score(X_train, y_train)))
	test_set_Accuracy = lr.score(X_test,y_test)
	list_testAccuracy.append(test_set_Accuracy)
	print '='*40

	for i in list_testAccuracy:
		print "Linear Regression accuracy on test set = {}".format(i)
	print '='*40
